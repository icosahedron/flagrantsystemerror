...
### flagrantsystemerror.com ###

> Having tired of fighting my WordPress installation for the hobbit-hole.org, I decided to move it to a static site.  As I was
...
> A new, dynamic, programming language with an emphasis on developing new dynamic programming languages.  See [artiface-lang.org](http://artiface-lang.org).
...
### <Span Style="Text-Decoration: Line-Through;">Blox</Span> ###
...
### <span style="text-decoration: line-through;">rst2wordml</span> ###

> This is an old project that served its purpose when I was coding in Python primarily.  It would translate ReST documents to WordML/MSWord documents.  The [source](http://hobbit-hole.org/rst2wordml.html) is available for those who wish to continue to use it.
