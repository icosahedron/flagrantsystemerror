---
title: Composing a Git Server
date: 2017-03-26
index: true
---

# Composing a Git Server

This is the [GitHub](https://github.com/icosahedron/git-vagrant-docker) README for a Vagrant/Docker Compose configuration I created to run a Gogs Git server. I've posted it here also for convenience.
